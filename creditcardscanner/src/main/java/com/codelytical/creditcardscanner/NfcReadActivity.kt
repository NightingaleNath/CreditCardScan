...
class NfcReadActivity : AppCompatActivity(), ReaderCallback {
        ...
        try {
            ...
            runOnUiThread {
               ...
               // Navigate only if I can do that here
                ...
                Log.d("PaymentResultCardNumber: ", leftPinTry.toString())
            ...
            Log.d("PaymentResultCardNumber: ", card.type.getName())
            Log.d("PaymentResultCardNumber: ", "${card.applications[0].leftPinTry} ${card.cplc}")
    ...
    private fun onNfcReadSuccessful(cardNumber: String, expiryDate: String, cardType: String, aid: String, application: String, leftPinTry: Int) {
        ...
        finish() // Close NfcReadActivity as we no longer need it
    }
}
